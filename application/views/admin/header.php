    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Event Media</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i> <?=$data['username']?> <i class="fa fa-caret-down"></i>
                    </a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        ?>
                        <li>
                            <a href="#"><i class="fa fa-send-o fa-fw"></i> Management Event<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?=site_url('event/kategori_list')?>">Kategori Event</a>
                                </li>
                                <li>
                                    <a href="<?=site_url('event/event_list')?>">Event</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
